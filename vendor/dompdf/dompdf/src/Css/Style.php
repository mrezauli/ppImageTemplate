...
class Style
{
    ...
    */
    ...
    {
        $this->_set_style_side_width_important('margin', 'top', "0px");
    }
    ...
    {
        $this->_set_style_side_width_important('margin', 'right', "0px");
    }
    ...
    {
        $this->_set_style_side_width_important('margin', 'bottom', "0px");
    }
    ...
    {
        $this->_set_style_side_width_important('margin', 'left', "0px");
    }
    ...
    function set_margin($val)
    {
        ...
        $this->_set_style_type_important('margin', '', "0px");
    }
